...
public class Seleksi extends javax.swing.JPanel {
    ...
    try{
        ...
        while(hasil.next()){
            ...
            String j = hasil.getString("hasil_penilaian");

            String[] data = {a, b, c, d, e, f, g, h, j};
            tabmode.addRow(data);
            i++;
        }
    ...
    private void initComponents() {
        ...
        judul.setText("  Ranking Hasil Seleksi Layanan Internet");
        ...
        tombolUpdate.setBackground(new java.awt.Color(255, 255, 0));
        ...
        jLabel5.setText("- Ranking diurutkan berdasarkan hasil penilaian terbesar sampai terkecil Layanan  Internet");
        ...
        tombolHapus.setBackground(new java.awt.Color(255, 0, 0));
        ...
        tombolLihatPerhitunganAHP.setBackground(new java.awt.Color(0, 255, 51));
        ...
        tombolLihatPerhitunganAHP.setText("Mulai Penilaian Layanan Internet Metode AHP");
    ...
    DialogPerhitunganAHP dialog1 =
        new DialogPerhitunganAHP((java.awt.Frame) javax.swing.SwingUtilities.getWindowAncestor(this), true);
