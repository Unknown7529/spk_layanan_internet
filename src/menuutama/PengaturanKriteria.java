    ...
    try{
        ...
        do{
            ...
            if(n == 1){
                ...
                kepentingan="Biasa ke-5"; // <-- ubah sesuai yang kamu mau
            }
...
protected void editDataKriteria(){
    ...
    private void initComponents() {
        ...
        judul.setForeground(new java.awt.Color(0, 255, 0));
        ...
        jLabel13.setText("Kriteria Kurang Penting ke-4");

        cbKriteria1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Fiber Optic", "FUP ( Fair Play Usage)", "Bandwidth", "Harga", "Layanan Tambahan", " " }));

        cbKriteria2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Fiber Optic", "FUP ( Fair Play Usage)", "Bandwidth", "Harga", "Layanan Tambahan", " " }));

        cbKriteria3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Fiber Optic", "FUP ( Fair Play Usage)", "Bandwidth", "Harga", "Layanan Tambahan", " " }));

        cbKriteria4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Fiber Optic", "FUP ( Fair Play Usage)", "Bandwidth", "Harga", "Layanan Tambahan", " " }));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel14.setText("Kriteria biasa ke-5");

        cbKriteria5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Fiber Optic", "FUP ( Fair Play Usage)", "Bandwidth", "Harga", "Layanan Tambahan", " " }));
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(cbKriteria5, javax.swing.GroupLayout.Alignment.LEADING, 0, 266, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void tombolSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolSimpanActionPerformed
     ...
     if (cbKriteria1.getSelectedIndex() != 0 &&
    cbKriteria2.getSelectedIndex() != 0 &&
    cbKriteria3.getSelectedIndex() != 0 &&
    cbKriteria4.getSelectedIndex() != 0 &&
